...
public class PacahonClient
{
	...
	public String get_ticket(String login, String credential, String from)
	{
		String ticket = null;
	...
	public boolean put(String ticket, Model data, String from)
	{
		UUID msg_uuid = UUID.randomUUID();
	...
	public Model get(String ticket, Model arg, String from) throws Exception
	{
		UUID msg_uuid = UUID.randomUUID();
