...
public class ZMQ {
	...
	static {
		...
		if (!EmbeddedLibraryTools.LOADED_EMBEDDED_LIBRARY)
		{
		    try
		    {
			System.out.print ("load jzmq lib");
			...
			try
			{
			    System.out.print ("load jzmq lib1");
			    System.loadLibrary ("jzmq1");						    
			}
			catch (Exception ex1)
			{
			    try
			    {
				System.out.print ("load jzmq lib2");
				System.loadLibrary ("jzmq2");						    
			    }
			    catch (Exception ex2)
			    {
				try
				{	
				    System.out.print ("load jzmq lib3");
				    System.loadLibrary ("jzmq3");						    
				}
				catch (Exception ex3)
				{
				    ex.printStackTrace ();
